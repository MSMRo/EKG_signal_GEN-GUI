# EKG_signal_GEN-GUI
Genera señales EKG para DSP en python. Es aplicación web interactiva genera y analiza señales ECG sintéticas, diseñada con Streamlit, NeuroKit2 y Plotly. Permite ajustar en tiempo real parámetros clave de la señal y obtener representaciones en dominio tiempo-frecuencia.
